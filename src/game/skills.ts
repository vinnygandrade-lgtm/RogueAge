...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Hamstring": { tipo: "debuff", mp: 30, poder: 0, cd: 15000, castMs: 650, desc: "Hobbles the enemy’s legs.", cor: "#64748b", icone: '<img src="assets/skills/hamstring.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Touch of Death": { tipo: "ataque_ultimate", mp: 150, poder: 8.0, cd: 120000, castMs: 2500, desc: "Supreme strike of darkness.", cor: "#7f1d1d", icone: '<img src="assets/skills/touch_of_death.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    ...
    "Holy Blessing": { tipo: "cura", mp: 50, poder: 0.3, cd: 15000, castMs: 1300, desc: "Divine light restores 30% HP.", cor: "#4ade80", icone: '<img src="assets/skills/holy_blessing.png" style="width: 35px; height: 35px; object-fit: contain;">' },
