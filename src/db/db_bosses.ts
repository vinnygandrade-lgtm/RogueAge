/**
 * Migrado: js/db_bosses.js
 */

import type { DailyBossCatalogEntry, RaidBossData } from '../types/game';

// ==========================================
// DATABASE: RAID BOSSES & EPIC ENCOUNTERS
// ==========================================

const catalogoBosses: Record<string, RaidBossData> = {
    'boss_antharas': {
        id: 'boss_antharas',
...
const catalogoBossesDiarios: Record<string, DailyBossCatalogEntry> = {
    daily_boss_ng: {
        id: 'daily_boss_ng',
...
// Ponte para módulos ES (Vite) — RaidEngine / daily boss leem via window.*
window.catalogoBosses = catalogoBosses;
window.catalogoBossesDiarios = catalogoBossesDiarios;
export {};
