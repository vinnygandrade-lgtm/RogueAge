...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Dash": { tipo: "buff_spd", mp: 15, poder: 1.5, cd: 30000, castMs: 450, desc: "Greatly increases move speed.", cor: "#3b82f6", icone: '<img src="assets/skills/hf_dash.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
