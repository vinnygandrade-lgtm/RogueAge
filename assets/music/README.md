...
| `hub.mp3` | In-game town / world / bag (not on a live expedition) | *Golden Hour Plaza* (original, 7 min, 64 kb/s) |
...
| `hub.mp3` | Golden Hour Plaza | project original | Downloads → 7 min re-encoded 64 kb/s stereo, cover stripped |
