...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Ultimate Evasion": { tipo: "buff_def", mp: 30, poder: 2.0, cd: 60000, desc: "Greatly increases evasion chance.", cor: "#a78bfa", icone: '<img src="assets/skills/hf_ultimate_evasion.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
