...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Power Strike": { tipo: "ataque", mp: 12, poder: 1.5, cd: 4000, castMs: 700, desc: "Heavy physical strike. Damage x1.5", cor: "#ef4444", icone: '<img src="assets/skills/power_strike.png" style="width: 35px; height: 35px; object-fit: contain; filter: drop-shadow(0 0 3px #000); pointer-events: none;">' },
