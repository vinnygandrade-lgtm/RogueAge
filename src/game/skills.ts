...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Dash": { tipo: "buff_spd", mp: 15, poder: 1.5, cd: 30000, castMs: 450, desc: "Greatly increases move speed.", cor: "#3b82f6", icone: '<img src="assets/skills/dash.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    ...
    "Deadly Blow": { tipo: "ataque", mp: 40, poder: 3.5, cd: 8000, castMs: 1400, desc: "Deadly dagger strike. Massive damage.", cor: "#059669", icone: '<img src="assets/skills/deadly_blow.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    ...
    "Fake Death": { tipo: "utilidade", mp: 20, poder: 0, cd: 60000, castMs: 500, desc: "Play dead to drop monsters’ aggro.", cor: "#6b7280", icone: '<img src="assets/skills/fake_death.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Stealth": { tipo: "utilidade", mp: 35, poder: 0, cd: 45000, castMs: 550, desc: "Turn invisible to non-aggressive monsters.", cor: "#4b5563", icone: '<img src="assets/skills/stealth.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Lethal Blow": { tipo: "ataque_ultimate", mp: 90, poder: 8.5, cd: 120000, castMs: 2500, desc: "Assassin's crown skill — chance of a one-hit kill.", cor: "#064e3b", icone: '<img src="assets/skills/lethal_blow.png" style="width: 35px; height: 35px; object-fit: contain;">' },
