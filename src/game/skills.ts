...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    ...
    "Whirlwind": { tipo: "ataque_area", mp: 45, poder: 1.6, cd: 7000, castMs: 1400, desc: "Spin your weapon, hitting ALL monsters.", cor: "#fb923c", icone: '<img src="assets/skills/whirlwind.png" style="width: 35px; height: 35px; object-fit: contain; filter: drop-shadow(0 0 3px #000); pointer-events: none;">' },
