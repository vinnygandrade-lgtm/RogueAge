/**
 * Catálogo de skills, árvore de aprendizado e spellbook
...
const bancoDeSkills: Record<string, SkillCatalogEntry> = Object.assign(
  {},
  {
    "Attack": { tipo: "basico", mp: 0, cd: 0, desc: "Basic attack. Essential for hunting.", cor: "#e2e8f0", icone: '<img src="assets/skills/hf_attack.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 4px rgba(0,0,0,0.9));">' },
    "Power Strike": { tipo: "ataque", mp: 12, poder: 1.5, cd: 4000, castMs: 700, desc: "Heavy physical strike. Damage x1.5", cor: "#ef4444", icone: '<img src="assets/skills/hf_power_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Wind Strike": { tipo: "ataque", mp: 15, poder: 1.6, cd: 4000, castMs: 650, desc: "Hurls a sharp wind blade. Fast magic damage.", cor: "#38bdf8", icone: '<img src="assets/skills/dem_wind_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 4px rgba(0,0,0,0.9));">' },
    ...
    "Lion Heart": { tipo: "buff_def", mp: 25, poder: 1.3, cd: 45000, desc: "Increases P. Def. by 30%.", cor: "#fbbf24", icone: '<img src="assets/skills/hf_lion_heart.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Double Strike": { tipo: "ataque", mp: 20, poder: 2.0, cd: 6000, desc: "Fast double hit. Damage x2.0", cor: "#f87171", icone: '<img src="assets/skills/hf_double_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Focus Attack": { tipo: "buff_atk", mp: 30, poder: 1.15, cd: 60000, desc: "Increases attack speed by 15%.", cor: "#38bdf8", icone: '<img src="assets/skills/hf_focus_attack.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Sonic Blaster": { tipo: "ataque", mp: 35, poder: 2.8, cd: 5000, desc: "Fires blade energy.", cor: "#38bdf8", icone: '<img src="assets/skills/hf_sonic_blaster.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Triple Sonic Slash": { tipo: "ataque", mp: 60, poder: 4.8, cd: 12000, desc: "Three simultaneous sonic cuts.", cor: "#0284c7", icone: '<img src="assets/skills/hf_triple_sonic_slash.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Duelist Spirit": { tipo: "buff_atk", mp: 50, poder: 1.45, cd: 60000, desc: "+45% P. Atk.", cor: "#facc15", icone: '<img src="assets/skills/hf_duelist_spirit.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Sonic Barrier": { tipo: "buff_def", mp: 55, poder: 1.6, cd: 60000, desc: "Sonic shield. +60% defense.", cor: "#06b6d4", icone: '<img src="assets/skills/hf_sonic_barrier.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    ...
    "Thunder Storm": { tipo: "ataque_area", mp: 70, poder: 2.5, cd: 14000, desc: "Area lightning burst.", cor: "#fbbf24", icone: '<img src="assets/skills/hf_thunder_storm.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Thrill Fight": { tipo: "buff_def", mp: 55, poder: 1.55, cd: 60000, desc: "+55% defense to hold the line.", cor: "#b45309", icone: '<img src="assets/skills/hf_thrill_fight.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Howl": { tipo: "debuff", mp: 40, poder: 0, cd: 20000, desc: "Lowers attack of nearby monsters.", cor: "#64748b", icone: '<img src="assets/skills/hf_howl.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Max Sonic Slash": { tipo: "ataque_ultimate", mp: 120, poder: 8.5, cd: 120000, desc: "Supreme single-target damage. Total obliteration.", cor: "#e11d48", icone: '<img src="assets/skills/hf_max_sonic_slash.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    ...
    "Whirlwind_K": { tipo: "ataque_area", mp: 20, poder: 1.2, cd: 6000, desc: "Spin your weapon, hitting ALL monsters.", cor: "#fb923c", icone: '<img src="assets/skills/hf_whirlwind_k.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Colossal Smash": { tipo: "ataque", mp: 25, poder: 2.5, cd: 8000, desc: "Brute-force blow. Damage x2.5", cor: "#ef4444", icone: '<img src="assets/skills/hf_colossal_smash.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Battle Roar": { tipo: "buff_atk", mp: 30, poder: 1.3, cd: 30000, desc: "Increases Attack by 30%.", cor: "#facc15", icone: '<img src="assets/skills/hf_battle_roar.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Iron Skin": { tipo: "buff_def", mp: 30, poder: 1.4, cd: 30000, desc: "Increases Defense by 40%.", cor: "#94a3b8", icone: '<img src="assets/skills/hf_iron_skin.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Drain Health": { tipo: "ataque_cura", mp: 40, poder: 2.0, cd: 12000, desc: "Shadow damage that heals you.", cor: "#8b5cf6", icone: '<img src="assets/skills/hf_drain_health.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Summon Panther": { tipo: "pet", mp: 80, poder: 0, cd: 120000, desc: "Summons the Black Panther to fight for you.", cor: "#111827", icone: '<img src="assets/skills/hf_summon_panther.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Iron Will": { tipo: "buff_def", mp: 35, poder: 1.4, cd: 40000, desc: "Greatly increases M. Def.", cor: "#94a3b8", icone: '<img src="assets/skills/hf_iron_will.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Hamstring": { tipo: "debuff", mp: 30, poder: 0, cd: 15000, castMs: 650, desc: "Hobbles the enemy’s legs.", cor: "#64748b", icone: '<img src="assets/skills/hf_hamstring.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    ...
    "Holy Strike": { tipo: "ataque", mp: 35, poder: 2.2, cd: 8000, desc: "Smash the foe with holy power.", cor: "#fef08a", icone: '<img src="assets/skills/hf_holy_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    ...
    "Holy Blessing": { tipo: "cura", mp: 50, poder: 0.3, cd: 15000, castMs: 1300, desc: "Divine light restores 30% HP.", cor: "#4ade80", icone: '<img src="assets/skills/hf_holy_blessing.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Majesty": { tipo: "buff_def", mp: 40, poder: 1.5, cd: 40000, desc: "Greatly increases P. Def.", cor: "#fbbf24", icone: '<img src="assets/skills/hf_majesty.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Phoenix Strike": { tipo: "ataque_ultimate", mp: 150, poder: 8.0, cd: 120000, desc: "Calls the Phoenix’s fire.", cor: "#f97316", icone: '<img src="assets/skills/hf_phoenix_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Mortal Strike": { tipo: "ataque", mp: 25, poder: 2.2, cd: 6000, desc: "Fast strike aimed at vitals.", cor: "#10b981", icone: '<img src="assets/skills/hf_mortal_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Vicious Stance": { tipo: "buff_atk", mp: 30, poder: 1.25, cd: 40000, desc: "Increases critical damage multiplier by 25%.", cor: "#ef4444", icone: '<img src="assets/skills/hf_vicious_stance.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Dash": { tipo: "buff_spd", mp: 15, poder: 1.75, cd: 30000, castMs: 450, desc: "Greatly increases Attack Speed for a short burst.", cor: "#3b82f6", icone: '<img src="assets/skills/hf_dash.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Ultimate Evasion": { tipo: "buff_def", mp: 30, poder: 2.0, cd: 60000, desc: "+20% Evasion investment for a short time (soft-capped with your gear).", cor: "#a78bfa", icone: '<img src="assets/skills/hf_ultimate_evasion.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Deadly Blow": { tipo: "ataque", mp: 40, poder: 3.5, cd: 8000, castMs: 1400, desc: "Deadly dagger strike. Massive damage.", cor: "#059669", icone: '<img src="assets/skills/hf_deadly_blow.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Backstab": { tipo: "ataque", mp: 50, poder: 4.5, cd: 12000, desc: "Treacherous backstab. Extreme positional damage.", cor: "#047857", icone: '<img src="assets/skills/hf_backstab.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Fake Death": { tipo: "utilidade", mp: 20, poder: 0, cd: 60000, castMs: 500, desc: "Play dead to drop monsters’ aggro.", cor: "#6b7280", icone: '<img src="assets/skills/hf_fake_death.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Stealth": { tipo: "utilidade", mp: 35, poder: 0, cd: 45000, castMs: 550, desc: "Turn invisible to non-aggressive monsters.", cor: "#4b5563", icone: '<img src="assets/skills/hf_stealth.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Lethal Blow": { tipo: "ataque_ultimate", mp: 90, poder: 8.5, cd: 120000, castMs: 2500, desc: "Assassin's crown skill — chance of a one-hit kill.", cor: "#064e3b", icone: '<img src="assets/skills/hf_lethal_blow.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Double Shot": { tipo: "ataque", mp: 35, poder: 2.8, cd: 6000, desc: "Fire two arrows almost at once.", cor: "#f97316", icone: '<img src="assets/skills/hf_double_shot.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    ...
    "Snipe": { tipo: "buff_atk", mp: 40, poder: 1.4, cd: 60000, desc: "Elite marksman stance. +40% P. Atk.", cor: "#ef4444", icone: '<img src="assets/skills/hf_snipe.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Rapid Shot": { tipo: "buff_spd", mp: 30, poder: 1.3, cd: 60000, desc: "Greatly increases attack speed.", cor: "#3b82f6", icone: '<img src="assets/skills/hf_rapid_shot.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Death Shot": { tipo: "ataque_ultimate", mp: 110, poder: 8.5, cd: 120000, desc: "The arrow of annihilation. Devastating damage.", cor: "#b91c1c", icone: '<img src="assets/skills/hf_death_shot.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Aura Burn": { tipo: "ataque", mp: 25, poder: 2.2, cd: 3000, castMs: 600, desc: "Burn the target with an energy blast.", cor: "#facc15", icone: '<img src="assets/skills/aura_burn.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Vampiric Touch": { tipo: "ataque_cura", mp: 35, poder: 1.8, cd: 8000, castMs: 1400, desc: "Steals life force to heal your HP.", cor: "#ef4444", icone: '<img src="assets/skills/vampiric_touch.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Concentration": { tipo: "buff_spd", mp: 30, poder: 1.3, cd: 60000, castMs: 900, desc: "Increases Casting Speed by 30%, shortening skill cast time.", cor: "#a855f7", icone: '<img src="assets/skills/concentration.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Flame Strike": { tipo: "ataque_area", mp: 45, poder: 1.5, cd: 10000, castMs: 1500, desc: "Rain of fire on all monsters.", cor: "#f97316", icone: '<img src="assets/skills/flame_strike.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Death Spike": { tipo: "ataque", mp: 50, poder: 3.8, cd: 5000, castMs: 1200, desc: "Bone spike. Extreme shadow damage.", cor: "#7e22ce", icone: '<img src="assets/skills/death_spike.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Summon Zombie": { tipo: "pet", mp: 80, poder: 0, cd: 120000, castMs: 2600, desc: "Raises an undead to fight beside you.", cor: "#65a30d", icone: '<img src="assets/skills/summon_zombie.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Curse Gloom": { tipo: "debuff", mp: 40, poder: 0, cd: 15000, castMs: 700, desc: "Severely lowers the enemy’s M. Def.", cor: "#4c1d95", icone: '<img src="assets/skills/curse_gloom.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Corpse Burst": { tipo: "ataque_area", mp: 75, poder: 3.0, cd: 12000, castMs: 1800, desc: "Detonates corpses for massive area damage.", cor: "#991b1b", icone: '<img src="assets/skills/corpse_burst.png" style="width: 35px; height: 35px; object-fit: contain;">' },
    "Gehenna": { tipo: "ataque_ultimate", mp: 150, poder: 9.0, cd: 120000, castMs: 2600, desc: "Calls the abyss. Catastrophic damage.", cor: "#000000", icone: '<img src="assets/skills/gehenna.png" style="width: 35px; height: 35px; object-fit: contain; filter: drop-shadow(0 0 5px red);">' },
    "Prominence": { 
  ...
  },
  {
    ...
    "Ultimate Evasion": { tipo: "buff_def", mp: 30, poder: 1.5, cd: 30000, desc: "+20% Evasion investment and a defense boost (soft-capped with your gear).", cor: "#d97706", icone: '<span style="font-size:24px;">💨</span>' },
  ...
  },
  {
    ...
    "Ultimate Evasion": { tipo: "buff_def", mp: 40, poder: 2.0, cd: 45000, desc: "+20% Evasion investment and a strong defense spike (soft-capped with your gear).", cor: "#fcd34d", icone: '<span style="font-size:24px;">💨</span>' },
  ...
  },
  {
    ...
    "Sweeper": { tipo: "utilidade", mp: 5, poder: 0, cd: 3000, desc: "Harvests bonus Adena and materials from a monster marked by Spoil.", cor: "#eab308", icone: '<span style="font-size:24px;">🧲</span>' },
    ...
    "Firm Strike": {
      ...
      cor: "#f87171",
      icone: '<img src="assets/skills/hf_firm_strike.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">',
    },
    "Battle Focus": {
      tipo: "buff_atk", mp: 14, poder: 1.12, cd: 40000,
      desc: "Sharpen your stance. Increases Attack by 12% for a short time.",
      cor: "#fb923c",
      icone: '<img src="assets/skills/hf_battle_focus.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">',
    },
    "Spark Bolt": {
    ...
    "Arcane Guard": {
      ...
      cor: "#a78bfa",
      icone: '<img src="assets/skills/hf_iron_will.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000) hue-rotate(200deg);">',
    },
  },
  // Human Fighter art wins for shared skill names (playable race; Object.assign last entry).
  {
    "Vicious Stance": { tipo: "buff_atk", mp: 30, poder: 1.25, cd: 40000, desc: "Increases critical damage multiplier by 25%.", cor: "#ef4444", icone: '<img src="assets/skills/hf_vicious_stance.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Ultimate Evasion": { tipo: "buff_def", mp: 30, poder: 2.0, cd: 60000, desc: "+20% Evasion investment for a short time (soft-capped with your gear).", cor: "#a78bfa", icone: '<img src="assets/skills/hf_ultimate_evasion.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
    "Deadly Blow": { tipo: "ataque", mp: 40, poder: 3.5, cd: 8000, castMs: 1400, desc: "Deadly dagger strike. Massive damage.", cor: "#059669", icone: '<img src="assets/skills/hf_deadly_blow.png" alt="" style="width:35px;height:35px;object-fit:contain;pointer-events:none;filter:drop-shadow(0 0 3px #000);">' },
...
// ==========================================
const linhagemClasses: Record<string, string[]> = {
    // === HUMANOS ===
    "Fighter": ["Fighter"],
...
window.spellbookFormatPowerCell = function (skill: SkillCatalogEntry | null | undefined): string {
...
window.spellbookIconInnerHtml = function (iconeHtml: string | undefined, px?: number): string {
    px = px || 38;
...
window.selecionarSkillSpellbook = function(nomeSkill: string) {
...
window.linhagemClasses = linhagemClasses;
if (typeof window.installRaidAttackHook === 'function') window.installRaidAttackHook();
